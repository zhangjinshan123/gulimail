<template>
  <el-dialog
    ...
    <el-form-item label="��¼����[1-web��2-app]" prop="loginType">
      <el-input v-model="dataForm.loginType" placeholder="��¼����[1-web��2-app]"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          loginType: [
            { required: true, message: '��¼����[1-web��2-app]不能为空', trigger: 'blur' }
          ]
        }
      }
    },
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              url: this.$http.adornUrl(`/gulimailmembe/memberloginlog/info/${this.dataForm.id}`),
              method: 'get',
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/gulimailmembe/memberloginlog/${!this.dataForm.id ? 'save' : 'update'}`),
              method: 'post',
